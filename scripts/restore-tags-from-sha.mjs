...
// Small helper to recreate tags locally from a tag->sha mapping file.
// Usage:
//   node scripts/restore-tags-from-sha.mjs --file path/to/tag-backup-<date>-sha.txt [--dry-run] [--force] [--push]
// Default: pick latest mapping under archives/tag-backups or scripts.

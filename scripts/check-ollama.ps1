...
Usage:
  powershell -NoProfile -ExecutionPolicy Bypass ./scripts/check-ollama.ps1       # read-only checks
  powershell -NoProfile -ExecutionPolicy Bypass ./scripts/check-ollama.ps1 -PullModel  # pull model if missing

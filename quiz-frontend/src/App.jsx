...
function App() {
  ...
  const subjectMeta = {
    ...
    "nyckeltal-exam": { label: t("subjects.nyckeltal-exam"), icon: "📊" },
    "produktkalkylering-exam": {
      label: t("subjects.produktkalkylering-exam"),
      icon: "🧾",
    },
    ams: { label: t("subjects.ams"), icon: "📚" },
    "ams-exam": {
      label: t("subjects.ams-exam"),
      icon: "📚",
    },
  };
